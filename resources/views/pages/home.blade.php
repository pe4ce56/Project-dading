...
@section('content')
  ...
  <div class="container text-center py-5">
    <div class="row">
      ...
      <div class="col-lg-6 my-3">
        <div class="col-lg-12 m-auto">
          <i class="fas fa-plus-square fa-5x d-inline px-0 text-main"></i>
        </div>
        <div class="col-lg-12 text-center px-0 my-3">
      ...
      <div class="col-lg-6 my-3">
        <div class="col-lg-12 m-auto">
          <i class="fas fa-user-md fa-5x d-inline px-0 text-main"></i>
        </div>
        <div class="col-lg-12 text-center px-0 my-3">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 my-3">
        <div class="col-lg-12 m-auto">
          <i class="fas fa-medkit fa-5x d-inline px-0 text-main"></i>
        </div>
        <div class="col-lg-12 text-center px-0 my-3">
      ...
      <div class="col-lg-6 my-3">
        <div class="col-lg-12 m-auto">
          <i class="fas fa-ambulance fa-5x d-inline px-0 text-main"></i>
        </div>
        <div class="col-lg-12 text-center px-0 my-3">
